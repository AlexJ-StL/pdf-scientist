...
class Settings(BaseSettings):
    ...
    # Ingestion
    pdf_dir: Path = Path("C:/Users/AlexJ/Documents/Coding/Repos/my-repos/EPA-Project/EPA_Methods_PDF")
    chunk_size: int = 512
    ...
    openrouter_embedding_dimensions: Optional[int] = 1536
    ...
    openrouter_llm_api_key: Optional[str] = None
    ...
    reranker_openrouter_api_key: Optional[str] = None
