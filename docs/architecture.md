...
| `metadata.py` | Heuristic (regex) metadata extraction + optional LLM enrichment (title/number from first page) |
...
**Stability:** `EPA_KG__RELOAD=false` (default) — prevents worker crash on file changes (WinError 10054)
